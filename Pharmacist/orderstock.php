...
<body  style="background-image:url(../sources/Images/ph.jpg)">
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top ">
  		<a class="navbar-brand" href="pharmacist.php">  
	  ...
	  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    	...
    	<ul class="navbar-nav float-sm-right">
			...
			<li class="nav-item dropdown dropleft">
					...
					<a class="dropdown-item" href="pharmacist.php">Home</a>
    ...
    <div class="table-responsive table  text-center justify-content-center col-auto" style="margin-left:auto; margin-right:auto; overflow-x:hidden;" >
     <div class="row"> 
          ...
          <form action="orderstock.php" method="POST" >
              <div class="form-row">
                  <div class="col">
  ...
  <div class="container-flex" style="width:100%" >
      <a href="pharmacist.php" value="Back to Admin Page" type="button" class="button btn btn-lg btn-dark" style="bottom:0; right:0; position:absolute">Back to POS Page</a>          
  </div>
