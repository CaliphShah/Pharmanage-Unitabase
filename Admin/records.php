<?php
  ...
  include "../Config/config.php";
    ...
    $sql="SELECT * FROM receipt ORDER BY r_id ASC;";
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top ">
  		<a class="navbar-brand" href="../pharm.html">  
    	...
    	<ul class="navbar-nav float-sm-right">
			...
			<li class="nav-item dropdown dropleft">
        		...
        		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
          		...
          		<a class="dropdown-item" href="../Unitabase/pharm.html">Home</a>
        		</div>
      		</li> 
    	</ul>
  	  </div>
                    ...
                    <tbody>
                        <?php foreach($sql2 as $sql3) : ?>
                            <tr>
                                ...
                                <td><?php echo $sql3['r_id']; ?></td>
                                <td><?php echo $sql3['c_name'];?></td>
                                <td><?php echo $sql3['total'];?></td>
                                <td><?php echo $sql3['time_placed'];?></td>
  ...
  <div class="container-flex" style="width:100%" >
      <a href="../Admin/admin.php" value="Back to Admin Page" type="button" class="button btn btn-lg btn-dark" style="bottom:0; right:0; position:absolute">Back to Admin Page</a>          
  </div>   
  </div>
